    ...
    func queryRestaurants(){
        do{
            ...
            for Rest in allRestaurants as! [Restaurants]{
                print("\(String(describing: Rest.r_ID)),\(String(describing: Rest.name))")
                for tag in Rest.tag as! Set<Tags>{
                    print("\(String(describing: tag.tag))")
                }
                for Con in Rest.contact as! Set<Contacts>{
                    print("\(String(describing: Con.contact))")
                }
                for Opt in Rest.opentime as! Set<Opentime>{
                    print("\(String(describing: Opt.day))")
                    print("\(String(describing: Opt.timeslot))")
                }
            }
        }catch{
            print(error)
